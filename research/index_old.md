...
<div class="research-page">
  ...
  <section id="projects" class="research-section">
    ...
    {% include card.html image="images/proj-dbs.jpg" title="DBS — HIV PrEP adherence & protection" text="Pharmacokinetic modeling that tests whether infrequent dried-blood-spot snapshots reflect real-world PrEP adherence and HIV protection in HPTN 067." %}

    {% include card.html image="images/proj-xcal.jpg" title="XCal — Explainable model calibration" text="Explainable-AI and clustering methods for interpreting calibration uncertainty and understanding why complex simulation models fit the way they do." %}

    {% include card.html image="images/proj-biomfg.jpg" title="Biomanufacturing digital twin" text="Simulation-based digital twin models for optimizing batch operations, resource allocation, and process performance in biomanufacturing systems." %}

    {% include card.html image="images/proj-abm.jpg" title="Korea-scale agent-based modeling" text="Agent-based simulation models for disease forecasting and public-health policy evaluation, including behavior-informed and network-based extensions." %}

    {% include card.html title="SynthNet" text="Synthetic populations and contact networks for disease-transmission simulation, including special institutional settings." %}

    {% include card.html title="Vaccine Decision LLM" text="Large language models for representing and supporting individual and population-level vaccine decision-making." %}
